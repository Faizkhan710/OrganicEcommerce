                            ...
                            <tbody>
                                ...
                                if(isset($_SESSION['Cart'])) {
                                    foreach ($_SESSION['Cart'] as $Key => $Value) { 
                                        $total = $total + $Value['ptotal'];//0+300 //300+500 = 800+200 =10000
                                   
                                ?>
                                    <tr>
                                        <td class="shoping__cart__item">
                                            <img src="<?= $Value['prodImg'] ?>" alt="" style = "width:90px;height:50px;">
...
function calc(){
    ...
    for(i = 0;i<price.length;i++){
        ...
        gt += (parseInt(qty[i].value) * parseInt(price[i].innerHTML)); //0 + 900 = 900+2500 = 
    }
